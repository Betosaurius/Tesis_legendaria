...
cardinalidad de dicho conjunto. De forma similar, llamamos aristas de $G$ y
tama\~no de $G$ a los elementos y cardinalidad de $E_G$ respectivamente. Por
convenci\'on, si $e={x,y}$ con $x,y\in V_G$ distintos, denotamos por $xy$ a la
arista $e$. Decimos que una gr\'afica $G$ es trivial si tiene orden $1$ y
tama\~no $0$, de lo contrario, esta es no trivial.
...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    \begin{scope}[scale=2.5]
      ...
      \node (1) [vertex2, label=90:$v_2$]  at (1,0){};
      \begin{scope}[xshift=2cm]
      \node (2) [vertex2,label=90:$v_3$]   at (270:1){};
      \node (3) [vertex2,label=0:$v_4$]    at (0:1){};
      \node (4) [vertex2,label=90:$v_5$]   at (90:1){};
      \end{scope}
      ...
      \draw [edge]  (0) to node [midway, above=5pt] {$e_2$} (1);
      \draw [edge]  (1) to node [midway, below=5pt] {$e_3$} (2);
      \draw [edge]  (2) to node [midway, below=5pt] {$e_4$} (3);
      \draw [edge]  (3) to node [midway, above=5pt] {$e_5$} (4);
      \draw [edge]  (4) to node [midway, above=5pt] {$e_6$} (1);
    \end{scope}
    \end{tikzpicture}
...
Dada una arista $e$ en $E_G$, decimos que un v\'ertice $u$ incide en $e$, y que
$e$ incide en $u$, si $u\in e$. Decimos que $e,f\in E_G$ distintas son
incidentes si existe $u\in V_G$ incidente en ambas $e$ y $f$, y decimos que
...
$v$ y viceversa. En \cref{fig:grafica-dibujo}, $v_1$ es incidente en $e_2$ y
$e_2$ es incidente en $v_1$, mientras que $e_1$ y $e_2$ son aristas incidentes y
$v_1$ y $v_2$ son v\'ertices adyacentes.
...
v\'ertices es $S$ y cuyo conjunto de aristas tiene a todas las $e\in E_G$
incidentes en al menos un v\'ertice en $S$. De forma similar, para $\varnothing
E\subseteq E_G$, denotamos por $G[E]$ a la subgr\'afica de $G$ cuyo conjunto de
aristas es $E$ y su conjunto de v\'ertices son todos aquellos $v\in V_G$ tales
que indicen en al menos una arista de $E$.
...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    \begin{scope}[scale=2.5]
      ...
      \node (1) [vertex2, label=90:$v_2$, fill=red]  at (1,0){};
      \begin{scope}[xshift=2cm]
      \node (2) [vertex2,label=90:$v_3$, fill=blue]   at (270:1){};
      \node (3) [vertex2,label=0:$v_4$, fill=blue]    at (0:1){};
      \node (4) [vertex2,label=90:$v_5$]   at (90:1){};
      \end{scope}
      ...
      \draw [edge, red]  (0) to node [midway, above=5pt] {$e_2$} (1);
      \draw [edge]  (1) to node [midway, below=5pt] {$e_3$} (2);
      \draw [edge, blue]  (2) to node [midway, below=5pt] {$e_4$} (3);
      \draw [edge]  (3) to node [midway, above=5pt] {$e_5$} (4);
      \draw [edge]  (4) to node [midway, above=5pt] {$e_6$} (1);
    \end{scope}
    \end{tikzpicture}
  \caption{La gr\'afica determinada por los v\'ertices y aristas rojas, $H$, es
...
por lo que denotamos por $K_n$ a la gr\'afica completa de orden $n$. Una gr\'afica $G$
es \indiceSub{gr\'afica}{bipartita} si $V_G$ puede partirse en dos subconjuntos
ajenos $X$ y $Y$ tales que toda arista incide en un v\'ertice en $X$ y en un
v\'ertice en $Y$. Tal partici\'on $(X,Y)$ es llamada una bipartici\'on de la
gr\'afica y $X$ y $Y$ son sus partes. Denotamos a una gr\'afica bipartita $G$
con una partici\'on $(X,Y)$ por $G[X,Y]$. Si $G[X,Y]$ es tal que ambos $X$ y $Y$
son distintos del vac\'io y todo v\'ertice de $X$ es adyacente a todo v\'ertice
de $Y$, decimos que $G$ es una gr\'afica \indiceSub{gr\'afica}{bipartita
completa}. En \cref{fig:grafica-dibujo2}, $X=\l{v_5}$ y $Y=\l{v_2,v_4}$ forman
una partici\'on $(X,Y)$ de la gr\'afica $G[\l{v_2,v_4,v_5}]$, que de hecho es
bipartita completa. Por otra parte, $X=\l{v_2}$ y $Y=\l{v_4}$ forman una
partici\'on $(X,Y)$ de $G[\l{v_2,v_4}]$, pero esta no es bipartita completa.
...
en el orden. Si $P$ es una trayectoria de orden $n$, suponemos sin p\'erida de
...
trayectorias de orden $n$ con $n\geq 1$, entonces $P\cong P'$, donde el
...
por $C_n$. La \indice{longitud} de una trayectoria o un ciclo es el tama\~no de
...
la existencia de un ciclo en $G$. Dadas dos gr\'aficas $G$ y $H$, definimos la
\indice{uni\'on} de $G$ y $H$, $G \cup H$, como la gr\'afica cuyo conjunto de
v\'ertices es $V_G\cup V_H$ y con conjunto de aristas $E_G\cup E_H$.
...
\begin{proof}
  ...
  considerar $H=G[E_P\triangle E_Q]$. Se afirma que $\delta_H\geq 2$. En efecto,
  ...
  distinta de la arista de $Q$ incidente en $v$, por lo que $d_H(v)\geq 2$.
...
\begin{proof}
  ...
  \[
      2\geq \Delta_G \geq d_G(v_i) \geq 3,  
  \]
...
y ac\'iclica. De esta definici\'on y d\cref{lem:trayectoria-ciclo} se tiene el
siguiente corolario inmediato.

\begin{corolario}
\label{cor:unitray}
  En un \'arbol $T$, para cualesquiera $u$ y $v$ v\'ertices existe una \'unica
  $uv$-trayectoria en $T$.
\end{corolario}
...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    \begin{scope}[scale=2.5]
      ...
      \node (1) [vertex2, label=90:$v_2$, fill=red]  at (1,0){};
      \begin{scope}[xshift=2cm]
      \node (2) [vertex2,label=90:$v_3$, fill=red]   at (270:1){};
      \node (3) [vertex2,label=0:$v_4$, fill=red]    at (0:1){};
      \node (4) [vertex2,label=90:$v_5$, fill=red]   at (90:1){};
      \end{scope}
      ...
      \draw [edge, red]  (0) to node [midway, above=5pt] {$e_2$} (1);
      \draw [edge, red]  (1) to node [midway, below=5pt] {$e_3$} (2);
      \draw [edge, red]  (2) to node [midway, below=5pt] {$e_4$} (3);
      \draw [edge, red]  (3) to node [midway, above=5pt] {$e_5$} (4);
      \draw [edge]  (4) to node [midway, above=5pt] {$e_6$} (1);
    \end{scope}
    \end{tikzpicture}
  \caption{Los v\'ertices y aristas de rojo inducen la gr\'afica
  $G[\l{e_2,e_3,e_4,e_5}]$, la cual es un \'arbol y tiene a $v_1$ y $v_5$ como
  hojas.}
...
$V_H=V_G\cup\l{v_e}$ con $v_e\notin V_G$ y $E_H=E_G\cup \l{v_ex, v_ey}
\setminus \l{xy}$.
...
\label{cor:eliminacion-arbol}
  Si $T$ un \'arbol y $x$ una de sus hojas, entonces $T-x$ es un \'arbol.
\end{corolario}
...
m\'as al usar las dos aristas incidentes en $v_e$. En tanto, de haber un ciclo
en $T'$, este utilizar\'ia a $v_e$ y a sus dos aristas, por lo que un ciclo de
un v\'ertice menos existir\'ia en $T$, contradiciendo que este es un \'arbol.
As\'i pues, se llega al siguiente corolario.

\begin{corolario}
\label{cor:subdivision-arbol}
  Si $T$ es un \'arbol y $e$ una de sus aristas, entonces la gr\'afica obtenida
...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    \begin{scope}[scale=2.5]
      ...
      \node (1) [vertex2, label=90:$v_2$, fill=blue]  at (1,0){};
      \begin{scope}[xshift=2cm]
      \node (2) [vertex2,label=180:$v_3$, fill=red]   at (270:1){};
      \node (3) [vertex2,label=0:$v_4$, fill=red]    at (0:1){};
      \node (4) [vertex2,label=90:$v_5$, fill=blue!50!white]   at (90:1){};
      \node (5) [vertex2,label=135:$v_6$, fill=red]   at (315:0.707){};
      \end{scope}
      ...
      \draw [edge, blue]  (0) to node [midway, above=5pt] {$e_2$} (1);
      \draw [edge]  (1) to node [midway, below=5pt] {$e_3$} (2);
      \draw [edge, red]  (2) to node [midway, above left=2pt] {$v_3v_6$} (5);
      \draw [edge, red]  (5) to node [midway, below right=2pt] {$v_6v_4$} (3);
      \draw [edge]  (3) to node [midway, above=5pt] {$e_5$} (4);
      \draw [edge, blue!50!white, dashed]  (4) to node [midway, above=5pt] {$e_6$} (1);
    \end{scope}
    \end{tikzpicture}
...
\indice{dominante} de $G$ si toda v\'ertice fuera de $S$ es adyacente a al menos
...
v\'ertice incidente en una arista de $M$, decimos que este est\'a saturado por
...
cantidad de v\'ertices de entre todos los emparejamientos. Denotamos por
$\alpha'(G)$ al \textbf{n\'umero de
emparejamiento}\index{emparejamiento!n\'umero de} de $G$, es decir, la
cardinalidad de un emparejamiento m\'aximo en $G$.
...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    \begin{scope}[scale=2.5]
      \node (0) [vertex2, label=180:$v_1$, fill=blue] at (0,0){};
      \node (1) [vertex2, label=90:$v_2$, node split half=90]  at (1,0){};
      \begin{scope}[xshift=2cm]
      \node (2) [vertex2,label=90:$v_3$, fill=red]   at (270:1){};
      \node (3) [vertex2,label=0:$v_4$, fill=red]    at (0:1){};
      \node (4) [vertex2,label=90:$v_5$, fill=red]   at (90:1){};
      ...
      \draw [edge, blue]  (0) to node [midway, above=5pt] {$e_2$} (1);
      \draw [edge]  (1) to node [midway, below=5pt] {$e_3$} (2);
      \draw [edge, red]  (2) to node [midway, below right=2pt] {$e_4$} (3);
      \draw [edge]  (3) to node [midway, above=5pt] {$e_5$} (4);
      \draw [edge, red]  (4) to node [midway, above=5pt] {$e_6$} (1);
    \end{scope}
    \end{tikzpicture}
...
\begin{proof}
  ...
  \begin{figure}[ht!]
    ...
    \begin{tikzpicture}
      \begin{scope}[scale=2.5]
        ...
        \node (2) [vertex2,label=90:$v_3$, fill=blue]   at (270:1){};
        \node (3) [vertex2,label=0:$v_4$, fill=red]    at (0:1){};
        \node (4) [vertex2,label=90:$z$, fill=blue]   at (90:1){};
        \end{scope}
        
        \draw [edge]  (0) to node [midway, above=5pt] {$e_1$} (1);
        \draw [edge]  (1) to node [midway, below=5pt] {$e_2$} (2);
        \draw [edge, verdeAzulado]  (2) to node [midway, below right=2pt] {$e_3$} (3);
        \draw [edge]  (3) to node [midway, above=5pt] {$e_4$} (4);
        \draw [edge, verdeAzulado]  (4) to node [midway, above=5pt] {$e_5$} (1);
      \end{scope}
      \end{tikzpicture}
  ...
  a v\'ertices en $B$. As\'i, $\abs{B} \geq \abs{R} - 1$ , mientras que cada
  v\'ertice en $B$ est\'a saturado por $M^*$ ya que, de lo contrario, la $M^*$
  trayectoria alternante de $u$ a $y$ ser\'ia $M^*$-aumentante, contradiciendo
  ...
  v\'ertice $y$ en $N(R)$ es alcanzado por $u$ a trav\'es de una
  $M^*$-trayectoria alternante hacia $x\in R$, $P$, y $xy\in E_G$. Si $y$ est\'a
  en $P$, $y\in B$, mientras que si no, $uPxy$ es una trayectoria
  $M^*$-alternante pues $x$ est\'a saturado por $M^*$, de manera que $xy\notin
  M^*$. Por tanto, $B=N(R)$ y
  \[
...
$k$-conjunto si $\abs{S}=k$. Dada una gr\'afica $G$ sin lazos y $1\leq k\leq
...
adyacentes si y solo $A\triangle B\in E_G$ (ver \cref{fig:grafica-fichas}). Una
observaci\'on inmediata de la definici\'on es que, si $G$ es una gr\'afica sin
lazos, $G$ es isomorfa a su gr\'afica de $1$ ficha, es decir, $G\cong \t{1}{G}$.
Esto es inmediato al ver que los $1$-conjuntos de $V_G$ son los unitarios de los
v\'ertices y que dos $1$-conjuntos son adyacentes en $\t{1}{k}$ si y solo si su
diferencia sim\'ertica es una arista en $G$, es decir, si estos son adyacentes
en $G$.
...
\centering
  \begin{tikzpicture} 
    ...
    \begin{scope}[shift={(2)}]
      \node (P1) [punto2,fill=black] at ({90}:1) {};
      \node (P2) [punto2,fill=black] at (0:0) {};
    \end{scope}

    \begin{scope}[shift={(3)}]
      \node (P3) [punto2,fill=black] at ({90}:1) {};
      \node (P4) [punto2,fill=black] at ({90 + 360/3}:1) {};
    \end{scope}

    \begin{scope}[shift={(4)}]
      \node (P5) [punto2,fill=black] at (0:0) {};
      \node (P6) [punto2,fill=black] at ({90 + 360/3}:1) {};
    \end{scope}

    \begin{scope}[shift={(5)}]
      \node (P7) [punto2,fill=black] at ({90 + (360/3)*2}:1) {};
      \node (P8) [punto2,fill=black] at ({90 + 360/3}:1) {};
    \end{scope}

    \begin{scope}[shift={(0)}]
      \node (P9) [punto2,fill=black] at ({90 + (360/3)*2}:1) {};
      \node (P10) [punto2,fill=black] at (0:0) {};
    \end{scope}

    \begin{scope}[shift={(1)}]
      \node (P11) [punto2,fill=black] at ({90 + (360/3)*2}:1) {};
      \node (P12) [punto2,fill=black] at ({90}:1) {};
    \end{scope}
  \end{tikzpicture}
...
d\'ia conocemos es de al rededor de 1980. El par\'ametro que nos dedicaremos a
...
toman turnos alternadamente para conseguir su objetivo. Por una parte, $C$
controla a una cantidad fija de polic\'ias, $c$, tales que estos ocupan
v\'ertices no necesariamente distintos de $G$ y, en cada turno, todos se mueven
a trav\'es de una arista incidente al v\'ertice en el que se encontraban
previamente. Por otro lado, $R$ controla a un \'unico ladr\'on cuyas reglas de
movimiento son las mismas que las descritas para los polic\'ias de $C$. Por
tanto, el objetivo de $C$ es que al menos uno de sus polic\'ias ocupe el mismo
v\'ertice que el ladr\'on, momento en el que diremos que dicho polic\'ia
\indice{captura} a $R$ y termina el juego de inmediato con la victoria de $C$.
En tanto, el objetivo de $R$ es evitar su captura, de manera que $R$ gana el
juego si puede hacer esto de forma indefinida. Por convenci\'on, $C$ comienza el
juego al escoger posiciones iniciales para cada uno de sus polic\'ias, mientras
que $R$ en su primer turno decide en qu\'e v\'ertice colocar a su ladr\'on.
...
\begin{proof}
  ...
  \'unica trayectoria en $T$ de el v\'ertice en el que se encuentra $C$ al
  ...
  Esto implica que, postrior al turno de $R$, la distancia entre $C$ y $R$ no
  ...
  ser $T$ no trivial. Luego, por inducci\'on se tiene que la distancia entre $C$
...
$\t{k}{G}$. Est\'a variante la introduce Fern\'andez en \cite{fernandez}. Para
una partida tradicional de polic\'ias y ladrones sobre $\t{k}{G}$, consid\'erse
una partida de polic\'ias y ladrones por equipos en $G$, donde cada polic\'ia de
$C$ y el ladr\'on tienen un equipo de $k$ fichas tales que, por cada polic\'ia y
el ladr\'on, sus $k$ fichas determinan un $k$-conjunto de $V_G$. Adem\'as, en su
turno, cada polic\'ia y el ladr\'on escogen una de sus $k$ fichas y la mueven de
un v\'ertice a otro a trav\'es de una arista, de manera que posterior a su
movimiento estos siguen determinando un $k$-conjunto de $V_G$. Por otra parte,
la acci\'on de que un polic\'ia o el ladr\'on pase en la gr\'afica de fichas se
corresponde con que el respectivo polic\'ia o el ladr\'on no mueva alguna de sus
fichas en $G$. En esta ocasi\'on, $C$ gana si en su turno logra que las $k$
fichas de uno de sus polic\'ias determinen el mismo $k$-conjunto que las $k$
fichas del ladr\'on, mientras que el ladr\'on gana si puede evitar que ello
sucede indefinidamente. En algunas ocasiones nos referiremos a los v\'ertices en
$\t{k}{G}$ como \textbf{configuraciones}\index{configuraci\'on}.

De este punto en adelante, denotamos por $c_i$ al $i$-\'esimo polic\'ia de $C$,
mientras que al ladr\'on, controlado por $R$, lo denotamos por $r$. Adem\'as,
nos interesa distinguir entre las fichas de $r$, por lo que, para cada $1\leq
j\leq k$ denotamos por $r_j$ a la $j$-\'esima ficha de $r$. M\'as a\'un, decimos
que un polic\'ia $c_i$ \indice{domina} una configuraci\'on $S\in V_{\t{k}{G}}$
si este se encuentra en $S$ o en una configuraci\'on adyacente a $S$ . Adem\'as,
decimos que una ficha de $c_i$ captura a $r_j$ si estas se encuentran en el
mismo v\'ertice, mientras que $c_i$ captura a $r_j$ si una ficha de $c_i$ le
captura. Finalmente, $c_i$ captura a $r$ si ambos determinan el mismo
$k$-conjunto de $V_{\t{k}{G}}$, mientras que $C$ captura a $R$ si $c_i$ captura
a $r$ para alguna $i$.