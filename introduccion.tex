...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    \begin{scope}[scale=2.5]
      ...
      \draw [edge, dashed, red]  (0) to node [midway, above=5pt] {$e_2$} (1);
      \draw [edge]  (1) to node [midway, below=5pt] {$e_3$} (2);
      \draw [edge, blue, dotted]  (2) to node [midway, below=5pt] {$e_4$} (3);
      \draw [edge]  (3) to node [midway, above=5pt] {$e_5$} (4);
      \draw [edge]  (4) to node [midway, above=5pt] {$e_6$} (1);
    \end{scope}
    \end{tikzpicture}
...
y ac\'iclica. De esta definici\'on y d\cref{pro:trayectoria-ciclo} se tiene el
...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    ...
    \end{scope}
    \end{tikzpicture}
  \caption{Los aristas de rojo inducen la gr\'afica $G[\l{e_2,e_3,e_4,e_5}]$, la
