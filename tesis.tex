...
\usepackage{tikz}
\usetikzlibrary{arrows,shapes,matrix,decorations,calc,positioning, shapes.geometric}
...
\tikzstyle{vertex}=[circle, draw, minimum size=6pt,
                    ...
                    outer sep=0pt]
\tikzstyle{punto}=[circle, draw, minimum size=10pt,
                    line width=0.75pt, inner sep=0pt,
                    outer sep=0pt]
\tikzstyle{cuadro}=[regular polygon, regular polygon sides = 4, draw, minimum size=10pt,
                    line width=0.75pt, inner sep=0pt,
                    outer sep=0pt]
...
\begin{scope}[style/.expanded=\polarshift{#1}{#2}]
  \node (SG5) [cuadro,fill=verdeOscuro] at (90:0.25) {};
