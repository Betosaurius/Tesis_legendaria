...
tiene ciclos de longitud $4$, sucede que para cualesquiera dos v\'ertices no
adyacentes, $u$ y $v$, existe una \'unica $uv$-trayectoria de longitud $2$.
As\'i, proponemos la siguiente cota superior.
...
\begin{proof}
    ...
    v\'ertices $x$ y $y$ en $S$, existe $i\in\seg{1}{4}$ tal que $c_i$ tiene sus
    ...
    en (b) de \cref{fig:initial} pues en cada v\'ertice hay al menos dos
    colores, de modo que si $c_{1,1}$ y $c_{2,2}$ no estuvieran a distancia $1$
    de sus objetivos, estos solo intercambiar\'ian sus colores (y sus formas en
    caso de ser necesario). Por otro lado, $c_{3,1}$ y $c_{4,2}$ se mueven para
    capturar $r_1$ y $r_2$ respectivamente. As\'i, si $c_3$ tuviera alguna de
    sus fichas a distancia $1$ de $r_1$, este reetiqueta en caso de ser
    necesario para que $c_{3,1}$ capture a $r_1$ en el mismo turno (y lo mismo
    sucede para $c_{4,2}$). No obstante, para cada $i\in\seg{1}{4}$, hay un
    v\'ertice de $S$ en el que no hay ninguna ficha de $c_i$, de modo que
    $c_{3,1}$ y $c_{4,2}$ puede que no capturen a sus objetivos en el primer
    turno de $C$. A pesar de ello, dado que la distancia entre cada par de
    v\'ertices de $P$ es a lo m\'as $2$, en el peor de los casos ambos $c_{3,1}$
    y $c_{4,2}$ se encuentran a distancia $1$ de sus respectivos objetivos
    (v\'ease (b) en \cref{fig:initial}).
    ...
    $N_P(a)=\l{u_1,v,u_2}$ y $N_P(b)=\l{w_1,v,w_2}$, notando que la intersecci\'on
    de ambos conjuntos es $\l{v}$ pues entre cualesquiera dos v\'ertices no
    adyacentes existe una \'unica trayctoria de longitud $2$. Sin p\'erdida de
    generalidad, sup\'ongase que la \'ulitma ficha movida por $R$ es $r_1$.
    Luego, $c_1$ y $c_3$ usan su movimiento para recapturar tal como se dijo al
    inicio del p\'arrafo. En tanto, sin p\'erdida de generalidad, $c_{2,1}$ y
    $c_{4,1}$ se mueven hacia un v\'ertice adyacente a $u_1$ y $u_2$
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            Luego, $R$ est\'a obligado a mover $r_2$ a $u_1$. Como $c_{3,2}$
            est\'a en $u_2$ o en $x$, este puede moverse para estar en la
            vecindad $z$. En tanto, $c_{2,2}$ y $c_{4,2}$ recapturan a $r_2$
            (v\'ease \cref{fig:guarding62}). Por tanto, $R$ no puede mover $r_2$
            a $z$ pues este pierde en a lo m\'as un turno, por lo que se ve
            obligado a mover $r_1$ a $b$ (v\'ease (c) en \cref{fig:guarding62}).
            N\'otese que $c_1$ se encuentra obstru\'ido al recapturar con
            $c_{1,1}$, por lo que este caso se reduce al 1, de modo que $R$ se
            ve obligado a poner sus fichas en v\'ertices adyacentes posterior al
            turno de $C$.
            ...
            \cref{fig:guarding2}). Al igual que en el subcaso anterior, $C$
            mueve como en (e) de \cref{fig:guarding2}, obligando a que $R$ mueva
            $r_2$ a $u_1$.
            ...
            \begin{figure}[H]
                ...
                ignorando los casos en los que alguno entre $c_{3,2}$ y
                $c_{1,2}$ est\'en en los v\'ertices negros sombreados o en $y$
                pues estos ya se cubrieron. En (d), $R$ mueve $r_1$ a $v$, por
                lo que $C$ mueve sus polic\'ias como en (e).}
                \label{fig:guarding2}
            \end{figure}

            Una vez m\'as, $R$ mueve $r_2$ a $u_1$. Nuevamente $c_{2,2}$ y
            $c_{4,2}$ recapturan, mientras que $c_{1,2}$ se mueve a $z$ y
            $c_{3,1}$ se mueve a $u_2$ (v\'ease \cref{fig:guarding5}). Sin
            importar si $R$ mueve $r_2$ de regreso a $w_1$ (como en (c) de
            \cref{fig:guarding5}) o mueve $r_1$ a $b$ (como en (e)), $C$ mueve
            como en (d) o en (f) respectivamente para forzar a $R$ a juntar las
            fichas $r_1$ y $r_2$.
            ...
            \begin{figure}[H]
                            ...
                            \tcblower
                                \scalebox{0.4}{
                                    \begin{tikzpicture}
                                        ...
                                        \unotB{2.5cm}{90 + (360/5)*3}
                                        \unopG{5cm}{90 + (360/5)*2}
                                        \unotR{2.5cm}{90 + (360/5)*4}
                                        \unopY{2.5cm}{90 + (360/5)}
                ...
                polic\'ias como en (b). Independientemente de lo que haga $R$ en
                su siguiente turno (moverse como en (c) o en (e)), $C$ forza que
                $R$ junte las fichas $r_1$ y $r_2$ al siguiente turno.}
                \label{fig:guarding5}
            \end{figure}
    ...
    \begin{enumerate}
        \item Si ninguno entre $c_{1,2}$ y $c_{3,1}$ est\'a en $b$ y no sucede
        que ambos esten $u_1$ o en $y$, entonces de (b) de \cref{fig:guarding7}
        es claro que $c_{1,2}$ y $c_{3,1}$ pueden ponerse, como en (c), en
        ...
        \begin{figure}[H]
            ...
            $c_{2,1}$ y $c_{4,1}$ en un v\'ertice azul sombreado y en un
            v\'ertice sombreado verde. Si alguno de ellos estuviera en los
            v\'ertices negros sombreados, en el v\'ertice azul no sombreado, o
            en el v\'ertice verde no sombreado, se sigue que $C$ captura a $R$
            en a lo m\'as un turn, o est\'a en una configuraci\'on ilegal, o
            est\'a en el siguiente caso. Por otra parte el resto de v\'ertices
            es tal que tiene al menos un v\'ertice verde sombreado y uno azul
            sombreado en su vecindad cerrada. Por tanto, siempre se pueden
            colocar $c_{2,1}$ y $c_{4,1}$ de manera que estos impiden que $r_1$
            se mueva los v\'ertices verde o azul sin sombrear. An\'alogamente,
            en (b) se mueven $c_{1,2}$ y $c_{3,2}$ a un v\'ertice azul y uno
            verde respectivamente. As\'i, $C$ termina su turno como se muestra
            en (c).}
            \label{fig:guarding7}
        \end{figure}
        ...
        \begin{figure}[H]
            ...
            reetiqueta sus fichas como en (b) y mueve como en (c), mientras que
            $c_{3,2}$ se asegura de estar en un v\'ertice adyacente a $y$
            (reetiquetando en caso de que $c_2$ tambi\'en estuviera
            obstru\'ida).}
            \label{fig:guarding8}
        \end{figure}
        ...
        a $y$. Luego, $C$ mueve como en (d) de \cref{fig:guarding9}, obligando a
        $R$ a pasar y, dos turnos despu\'es, ser capturado.
                    ...
                    \tcblower
                        \scalebox{0.4}{
                            \begin{tikzpicture}
                                ...
                                \unopBunopR{5cm}{90 + (360/5)*2}
                                \unotBunotG{5cm}{90}
                                \unotYt{5cm}{90 + (360/5)*4}
                                \unopG{2.5cm}{90 + (360/5)*4}
                                \unopY{2.5cm}{90 + (360/5)*3}
                                \unotR{5cm}{90 + (360/5)*3}
