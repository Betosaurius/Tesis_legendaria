\chapter{Polic\'ias y ladrones sobre gr\'aficas de fichas de inter\'es}
    ...
    \begin{figure}[!htbp]
        \centering
            \scalebox{0.7}{
                \begin{tikzpicture}
                    \petersen
                    \node (1) [bola34, fill=Crimson]  at ({(360/5)*0 + 90}:2.25){};
                    \node (2) [bola34, fill=Crimson]  at ({(360/5)*2 + 90}:1.125){};
                    \node (3) [bola34, fill=Crimson]  at ({(360/5)*3 + 90}:1.125){};
                \end{tikzpicture}
            }
        \captionsetup{font=footnotesize}
...
\begin{proof}
    ...
    \cref{pro:dominante-petersen}, para cualquier par de v\'ertices de $P$, existe
    ...
    tiene a lo m\'as dos posibles movimientos. N\'otese que
    $\abs{N_P(c_1(t))\cap N_P(r(t))}=1$ ya que de lo contrario habr\'ia un ciclo
    ...
    Similarmente, $\abs{N_P(c_2(t))\cap N_P(r(t))}\neq 2$ pues, de lo contrario,
    $P$ tendr\'ia un ciclo de longitud $4$. As\'i, $r$ tendr\'ia al menos un
    v\'ertice al cual moverse para sobrevivir al siguiente turno de $C$.
...
observemos que, de \cref{pro:dominante-petersen}, se tiene que la distancia
m\'axima entre dos v\'ertices de $P$ es $2$. Una observaci\'on \'util acerca de
$P$ que se deduce de \cref{fig:petersen-dominante} es que cualesquiera dos de
sus v\'ertices est\'an a lo m\'as a distancia $2$. Adem\'as, dado que $P$ no
tiene ciclos de longitud $4$, para cualesquiera dos v\'ertices no adyacentes,
$u$ y $v$, existe una \'unica $uv$-trayectoria de longitud $2$. As\'i,
proponemos la siguiente cota superior.
...
\begin{proof}
    ...
    Para la primera etapa, como $\gamma(P)=3$, existe un conjunto dominante
    $S\subseteq V_P$, con $ \abs{S}=3$. Luego, $C$ puede escoger su
    configuraci\'on inicial de manera que, para cada dos v\'ertices $x$ y $y$ en
    $S$, existe $i\in\seg{1}{4}$ tal que $c_i$ tiene sus fichas en $x$ y $y$
    (v\'ease (a) en \cref{fig:initial}). En su primer turno despu\'es de escoger
    su configuraci\'on inicial, $c_{1,1}$ y $c_{2,2}$ pueden capturar a $r_1$ y
    $r_2$ respectivamente. Esto se puede ver en (b) de \cref{fig:initial} pues
    en cada v\'ertice hay al menos dos colores, de modo que si $c_{1,1}$ y
    $c_{2,2}$ no estuvieran a distancia $1$ de sus objetivos, estos solo
    intercambiar\'ian sus colores (y sus formas en caso de ser necesario). Por
    otro lado, $c_{3,1}$ y $c_{4,2}$ se mueven para capturar $r_1$ y $r_2$
    respectivamente. As\'i, si $c_3$ tuviera alguna de sus fichas a distancia
    $1$ de $r_1$, este reetiqueta en caso de ser necesario para que $c_{3,1}$
    capture a $r_1$ en el mismo turno (y lo mismo sucede para $c_{4,2}$). No
    obstante, para cada $i\in\seg{1}{4}$, hay un v\'ertice de $S$ en el que no
    hay ninguna ficha de $c_i$, de modo que $c_{3,1}$ y $c_{4,2}$ puede que no
    capturen a sus objetivos en el primer turno de $C$. A pesar de ello, dado
    que la distancia entre cada par de v\'ertices de $P$ es a lo m\'as $2$, en
    el peor de los casos ambos $c_{3,1}$ y $c_{4,2}$ se encuentran a distancia
    $1$ de sus respectivos objetivos (v\'ease (b) en \cref{fig:initial}).
            ...
            \tcbitem
                \tcblower
                    \scalebox{0.7}{
                        \begin{tikzpicture}
                                \petersen
                                \unopBunopYunotR{2.25cm}{90 + (360/5)*2}
                                \unotBunotYunopG{1.125cm}{90 + (360/5)*4}
                                \unotGunopRdos{1.125cm}{90}
                        \end{tikzpicture}
                    }
            ...
            \tcbitem
                \tcblower
                    \scalebox{0.7}{
                        \begin{tikzpicture}
                            \petersen
                            \unopBpdos{2.25cm}{90 + (360/5)*3}
                            \unopRdos{1.125cm}{90 + (360/5)*3}
                            \unotGtdos{2.25cm}{90}
                            \unotY{2.25cm}{90 + (360/5)*4}
                            \unotBunopGdos{1.125cm}{90 + (360/5)*4}
                            \unotRunopY{2.25cm}{90 + (360/5)*2}
                        \end{tikzpicture}
                    }
            \end{tcbitemize}
        \captionsetup{font=footnotesize}
    ...
    un $C_6$ inducido en $G$ (incapaz de moverse mas que en una direcci\'on pues
    $c_{3,1}$ le bloquea un v\'ertice sobre el $C_6$, v\'ease (a) en
    \cref{fig:cycle}). As\'i, $c_2$ o $c_4$ podr\'ian posicionar su primera
    ficha sobre el ciclo de manera que, eventualmente, $r_1$ no puede avanzar
    sobre el $C_6$ pues ambos $c_{2,2}$ y $c_{4,2}$ ya captuan a $r_2$. Por
    tanto, $R$ solo puede pasar o mover $r_1$ hacia atr\'as sobre $C_6$ (de
    manera que $c_{3,1}$ captura a $r_1$), o mover $r_1$ hacia la vecindad de
    $c_{3,2}(t)$. En cualquiera de los casos, $c_{3,1}$ termina por capturar a
    $r_1$, de manera que ambos $c_{3,1}$ y $c_{4,2}$ capturan a sus respectivos
    objetivos (v\'ease (d) en \cref{fig:cycle}).
            ...
            \tcbitem
                \tcblower
                    \scalebox{0.7}{
                        \begin{tikzpicture}
                                \petersendos
                                \unotGunotYt{2.25cm}{90 + (360/5)}
                                \unopBpdos{1.125cm}{90 + (360/5)*4}
                                \unopRdos{2.25cm}{90 + (360/5)*4}
                                \unotRunopY{2.25cm}{90 + (360/5)*2}
                                \unopGdos{2.25cm}{90}
                                \unotBdos{1.125cm}{90 + (360/5)}
                ...
                \tcblower
                    \scalebox{0.7}{
                        \begin{tikzpicture}
                            \petersendos
                            \unotGunotYt{2.25cm}{90 + (360/5)}
                            \unopBpdos{1.125cm}{90 + (360/5)}
                            \unotBunopRdos{1.125cm}{90 + (360/5)*4}
                            \unotRunopY{2.25cm}{90 + (360/5)*2}
                            \unopGdos{2.25cm}{90}
                ...
                \tcblower
                    \scalebox{0.7}{
                        \begin{tikzpicture}
                            \petersendos
                            \unotGunotYt{2.25cm}{90 + (360/5)}
                            \unopBpdos{1.125cm}{90 + (360/5)*3}
                            \unotBdos{1.125cm}{90 + (360/5)*4}
                            \unopRdos{1.125cm}{90 + (360/5)}
                            \unotRunopY{2.25cm}{90 + (360/5)*2}
                            \unopGdos{2.25cm}{90}
    ...
    $c_{4,2}$ recapturan cada que $R$ mueva $r_2$. Sup\'ongase que $r_1$ y $r_2$
    no est\'an en v\'ertices adyacentes. Sean $r_1(t)=a$, $r_2(t)=b$,
    $N_P(a)=\l{u_1,v,u_2}$ y $N_P(b)=\l{w_1,v,w_2}$, notando que la
    intersecci\'on de ambos conjuntos es $\l{v}$ pues entre cualesquiera dos
    v\'ertices no adyacentes existe una \'unica trayectoria de longitud $2$. Sin
    p\'erdida de generalidad, sup\'ongase que la \'ulitma ficha movida por $R$
    es $r_1$. Luego, $c_1$ y $c_3$ usan su movimiento para recapturar tal como
    se dijo al inicio del p\'arrafo. En tanto, sin p\'erdida de generalidad,
    $c_{2,1}$ y $c_{4,1}$ se mueven hacia un v\'ertice adyacente a $u_1$ y $u_2$
    respectivamente. N\'otese que esto es posible pues, desde cualquier
    v\'ertice en el que $c_{2,1}$ y $c_{4,1}$ pudieran estar, $C$ puede mover
    uno hacia la vecindad de $u_1$ y el otro a la vecindad de $u_2$ (v\'ease
    \cref{fig:guarding0}).
            ...
            \tcbitem
                \tcblower
                    \scalebox{0.7}{
                        \begin{tikzpicture}
                            \petersentres
                            \unopBunopRpdos{1.125cm}{90 + (360/5)*2}
                            \unotGunotYt{2.25cm}{90 + (360/5)}
                ...
                \tcblower
                    \scalebox{0.7}{
                        \begin{tikzpicture}
                            ...
                            \unopBunopRpdos{1.125cm}{90 + (360/5)*2}
                            \unotGunotYt{2.25cm}{90 + (360/5)}
                            \unopGdos{1.125cm}{90 + (360/5)*3}
                            \unopY{2.25cm}{90 + (360/5)*4}
                            
                        \end{tikzpicture}
                    }
        \end{tcbitemize}
        \captionsetup{font=footnotesize}
        \caption{En esta figura se omiten las fichas $c_{1,2}$ y $c_{3,2}$. En
        (a), $R$ acaba de mover $r_1$, de modo que $c_{1,1}$ y $c_{3,1}$ le han
        recapturado. Se busca posicionar a $c_{2,1}$ y $c_{4,1}$ adyacentes a
        $u_1$ y $u_2$. Si alguno entre $c_{2,1}$ y $c_{4,1}$ estuviera en un
        v\'ertice negro sombreado, $C$ ganar\'ia en a lo m\'as un turno o un
        polic\'ia tendr\'ia sus dos fichas en un mismo v\'ertice, lo cual es
        imposible. De forma similar, si alguno entre $c_{2,1}$ y $c_{4,1}$
        estuviera en $u_1$ o en $u_2$, entonces $C$ gana en su siguiente turno.
        Para cada uno de los v\'ertices restantes existe un v\'ertice azul
        sombreado y un v\'ertice verde sombreado en su vecindad cerrada,
        determinando el movimiento de ambos $c_{2,1}$ y $c_{4,1}$ como se
        ilustra en (b) y (c).}
        \label{fig:guarding0}
    \end{figure}
    ...
    $r_2$. En cualquier caso, $R$ mueve $r_2$ y se puede asumir sin p\'erdida de
    generalidad que su nueva posici\'on es $w_1$. Sea $N_P(w_1)=\l{u_1, b,y}$.
    Luego, $c_{2,2}$ y $c_{4,2}$ recapturan $r_2$ y se generan dos casos
    dependiendo de si se tiene una obstrucci\'on:
    ...
    \begin{enumerate}
        ...
        $w_1$, de manera que $R$ no puede mantener sus fichas en v\'ertices no
        adyacentes (v\'ease \cref{fig:guarding}).
        ...
        \begin{figure}[ht!]
                    ...
                    \tcblower
                        \scalebox{0.7}{
                            \begin{tikzpicture}
                                \petersencinco
                                \unopBunopRpdos{1.125cm}{90 + (360/5)*2}
                                \unotGunotY{2.25cm}{90 + (360/5)}
                                \unopGtdos{2.25cm}{90}
                                \unotBdos{1.125cm}{90 + (360/5)*4}
                                \unotRdos{1.125cm}{90 + (360/5)*3}
                                \unopY{2.25cm}{90 + (360/5)*4}
                    ...
                    \tcblower
                        \scalebox{0.7}{
                            \begin{tikzpicture}
                                \petersen
                                \unopBunopRpdos{1.125cm}{90 + (360/5)*2}
                                \unopGdos{2.25cm}{90 + (360/5)}
                                \unotGunotYt{2.25cm}{90}
                                \unotBdos{1.125cm}{90 + (360/5)*4}
                                \unotRdos{1.125cm}{90 + (360/5)}
                                \unopY{2.25cm}{90 + (360/5)*4}
                    ...
                    \tcblower
                        \scalebox{0.7}{
                            \begin{tikzpicture}
                                \petersen
                                \unopBunopRpdos{1.125cm}{90 + (360/5)*2}
                                \unopGdos{2.25cm}{90 + (360/5)*2}
                                \unotGunotYt{2.25cm}{90}
                                \unotBdos{2.25cm}{90 + (360/5)*4}
                                \unotRdos{2.25cm}{90 + (360/5)*1}
                                \unopY{1.125cm}{90 + (360/5)*4}
                                
                            \end{tikzpicture}
                        }
            \end{tcbitemize}
            \captionsetup{font=footnotesize}
            \caption{En (a), $R$ acaba de mover $r_2$, de manera que $c_{4,2}$
            recaptura y $c_2$ reetiqueta sus fichas. En tanto, $c_{1,2}$ y
            $c_{3,2}$ se mueven como en (b) para posicionarse en un v\'ertice
            adyacente a $y$ y un v\'ertice adyacente a $b$ respectivamente (lo
            cual es posible pues cualquier v\'ertice es adyacente a uno verde
            sombreado y a uno azul sombreado en (a), ignorando los v\'ertices
            sombreados de negro y el azul y verde sin sombrear pues $C$ gana al
            siguiente turno o est\'a en una posici\'on ilegal). El reetiquetado
            ...
            Luego, $R$ solo puede pasar si es que quiere evitar que $r_1$ y
            $r_2$ est\'en en v\'ertices adyacentes. No obstante, $C$ mueve sus
            polic\'ias como en (d), forzando el movimiento de $R$.}
            \label{fig:guarding}
        \end{figure}

        \item Si no se tiene una obstrucci\'on, se generan tres subcasos:
        \begin{enumerate}
            \item Si alguno entre $c_{1,2}$ y $c_{3,2}$ est\'a en la vecindad de
            $b$ (v\'ease \cref{fig:guarding1}), sup\'ongase sin p\'erdida de
            generalidad que es $c_{1,2}$, de modo que este se mueve hacia $b$ y
            $c_{3,2}$ se posiciona en la vecindad de $y$ (v\'ease (c) en
            \cref{fig:guarding1}). Esto obliga a $R$ a mover $r_1$ a $v$.
            Posterior al movimiento de $R$, $c_{1,1}$ y $c_{3,1}$ recapturan,
            mientras que $c_{4,1}$ se posiciona en la vecindad $a$ (ver (d) y
            (e) \cref{fig:guarding1}).
            ...
            \begin{figure}[ht!]
                        ...
                        \tcblower
                            \scalebox{0.7}{
                                \begin{tikzpicture}
                                    ...
                                    \unotGunotY{2.25cm}{90 + (360/5)}
                                    \tridos{2.25cm}{90}
                                    \unotBunotRdos{2.25cm}{90 + (360/5)*2}
                                    \unopGdos{1.125cm}{90 + (360/5)*3}
                                    \unopY{2.25cm}{90 + (360/5)*4}
                        ...
                        \tcblower
                            \scalebox{0.7}{
                                \begin{tikzpicture}
                                    ...
                                    \unopBunopRpdos{1.125cm}{90 + (360/5)*2}
                                    \unotGunotYt{2.25cm}{90}
                                    \unotRdos{2.25cm}{90 + (360/5)*3}
                                    \unotBdos{2.25cm}{90 + (360/5)}
                                    \unopGdos{1.125cm}{90 + (360/5)*3}
                                    \unopY{2.25cm}{90 + (360/5)*4}
                    ...
                    \tcbitem
                        \tcblower
                            \scalebox{0.7}{
                                \begin{tikzpicture}
                                    \petersen
                                    \unopBunopRdos{1.125cm}{90 + (360/5)*2}
                                    \puntodos{2.25cm}{90 + (360/5)*2}
                                    \unotGunotYt{2.25cm}{90}
                                    \unotRdos{2.25cm}{90 + (360/5)*3}
                                    \unotBdos{2.25cm}{90 + (360/5)}
                                    \unopGdos{1.125cm}{90 + (360/5)*3}
                    ...
                    \tcbitem[raster multicolumn=2]
                        \tcblower
                            \scalebox{0.7}{
                                \begin{tikzpicture}
                                    \petersen
                                    \unopBunopRpdos{2.25cm}{90 + (360/5)*2}
                                    \unotGunotYt{2.25cm}{90}
                                    \unopGunotRdos{2.25cm}{90 + (360/5)*3}
                                    \unotBdos{2.25cm}{90 + (360/5)}
                                    \unopY{1.125cm}{90 + (360/5)*4}
                ...
                es usual, mientras que $c_{1,2}$ se mueve hacia $b$ y $c_{3,2}$
                se posiciona en la vecindad de $y$. N\'otese que se ignorar\'an
                los casos en los que alguno entre $c_{1,2}$ y $c_{3,2}$ est\'an
                en los v\'ertices sombreados de negro o en $y$ pues $C$ gana en
                a lo m\'as un turno o est\'a en una posici\'on ilegal. En (d),
                $R$ acaba de mover $r_1$ a $v$, por lo que $C$ mueve como en (e)
                para forzar el movimiento de $R$.}
                \label{fig:guarding1}
            \end{figure}

            Luego, $r_2$ debe moverse a $u_1$. Como $c_{3,2}$ est\'a en $u_2$ o
            en $x$, este puede moverse para estar en la vecindad $z$. En tanto,
            $c_{2,2}$ y $c_{4,2}$ recapturan a $r_2$ (v\'ease
            \cref{fig:guarding62}). As\'i, $r_2$ no puede moverse a $z$ pues $R$
            pierde en a lo m\'as un turno, por lo que se ve obligado a mover
            $r_1$ a $b$ (v\'ease (c) en \cref{fig:guarding62}). N\'otese que
            $c_{1,1}$ se encuentra obstru\'ido al recapturar, por lo que este
            caso se reduce al 1.
            ...
            \begin{figure}[ht!]
                        ...
                        \tcblower
                            \scalebox{0.7}{
                                \begin{tikzpicture}
                                    \petersencero
                                    \unopBunopRpdos{2.25cm}{90 + (360/5)*2}
                                    \unotGunotY{2.25cm}{90}
                                    \tridos{1.125cm}{90}
                                    \unotRunopY{1.125cm}{90 + (360/5)*4}
                                    \unotBdos{2.25cm}{90 + (360/5)}
                                    \unopGdos{2.25cm}{90 + (360/5)*3}
                    ...
                    \tcbitem[raster multicolumn=2]
                        \tcblower
                            \scalebox{0.7}{
                                \begin{tikzpicture}
                                    \petersen
                                    \unopBunopRdos{2.25cm}{90 + (360/5)*2}
                                    \unotGunotYt{1.125cm}{90}
                                    \unopY{1.125cm}{90 + (360/5)*4}
                                    \unotRdos{1.125cm}{90+ (360/5)*1}
                                    \unotBpdos{2.25cm}{90 + (360/5)}
                                    \unopGdos{2.25cm}{90 + (360/5)*3}
                ...
                mueve como en (b) para forzar el movimiento de $r_1$ a $b$,
                quedando en una situaci\'on an\'aloga a la mostrada en (a) de
                \cref{fig:guarding}.}
                \label{fig:guarding62}
            \end{figure}

            \item Si lo anterior no ocurre y alguno est\'a en la vecindad de
            $w_2$ y el otro est\'a en la vecindad de $y$, sup\'ongase sin
            p\'erdida de generalidad que $c_{1,2}$ est\'a en la vecindad de
            $w_2$. As\'i, $c_{1,2}$ se mueve a $w_2$ y $c_{3,2}$ se mueve a $y$,
            obligando el movimiento de $r_1$ a $v$ (v\'ease
            \cref{fig:guarding2}). De aqu\'i, $C$ mueve como en (e) de
            \cref{fig:guarding2}, obligando a que $R$ mueva $r_2$ a $u_1$.
            ...
            \begin{figure}[H]
                ...
                mueven como en (c) (ver continuaci\'on de figura) para obligar
                el movimiento de $r_1$ a $v$.}
                \label{fig:guarding2}
            \end{figure}
                        ...
                        \tcblower
                            \scalebox{0.7}{
                                \begin{tikzpicture}
                                    ...
                                    \unopGdos{2.25cm}{90 + (360/5)*3}
                                    \unopY{1.125cm}{90 + (360/5)*4}
                                    \unotRdos{2.25cm}{90 + (360/5)*4}
                                    
                                \end{tikzpicture}
                            }
                \end{tcbitemize}
                \captionsetup{font=footnotesize}
                \caption{En (d), $R$ mueve $r_1$ a $v$, por lo que $C$ mueve sus
                polic\'ias como en (e).}
            \end{figure}

            Una vez m\'as, $R$ mueve $r_2$ a $u_1$ y $c_{2,2}$ y $c_{4,2}$
            recapturan, mientras que $c_{1,2}$ se mueve a $z$ y $c_{3,1}$ a
            $u_2$. Sin importar si $R$ mueve $r_2$ de regreso a $w_1$ (como en
            (c) de \cref{fig:guarding5}) o mueve $r_1$ a $b$ (como en (e)), $C$
            mueve como en (d) o en (f) respectivamente para forzar a $R$ a
            juntar las fichas $r_1$ y $r_2$.
            ...
            \begin{figure}[ht!]
                ...
                \end{tcbitemize}
                \captionsetup{font=footnotesize}
                \caption{Si $R$ mueve $r_2$ a $u_1$ como en (a), $C$ mueve a sus
                polic\'ias como en (b).}
                \label{fig:guarding5}
            \end{figure}
                    ...
                    \tcbitem
                            \tcblower
                                \scalebox{0.7}{
                                    \begin{tikzpicture}
                                        \petersen
                                        \unopBunopRpdos{2.25cm}{90 + (360/5)}
                                        \unotGunotYt{1.125cm}{90}
                                        \unotBdos{1.125cm}{90 + (360/5)*3}
                                        \unopGdos{2.25cm}{90 + (360/5)*2}
                                        \unotRdos{1.125cm}{90 + (360/5)*4}
                                        \unopY{1.125cm}{90 + (360/5)}
                                        
                                    \end{tikzpicture}
                                }
                \end{tcbitemize}
                \captionsetup{font=footnotesize}
                \caption{Independientemente de lo que haga $R$ en su siguiente
                turno (moverse como en (c) o en (e)), $C$ forza que $R$ junte
                las fichas $r_1$ y $r_2$ al siguiente turno.}
            \end{figure}

            \item Si los anteriores casos no suceden, $c_{1,2}$ y $c_{3,2}$
            deben estar ambos en $z$ o en $x$ (v\'ease \cref{fig:guarding3}). En
            este caso, $C$ mueve las fichas de manera que $c_{1,2}$ termina en
            $z$ y $c_{3,2}$ est\'a en $x$.
                        ...
                        \tcblower
                            \scalebox{0.7}{
                                \begin{tikzpicture}
                                    ...
                                    \unotGunotY{2.25cm}{90 + (360/5)}
                                    \tridos{2.25cm}{90}
                                    \unotBunotRdos{2.25cm}{90 + (360/5)*3}
                                    \unopGdos{1.125cm}{90 + (360/5)*3}
                                    \unopY{2.25cm}{90 + (360/5)*4}
            ...
            \begin{figure}[ht!]
                        ...
                        \tcblower
                            \scalebox{0.7}{
                                \begin{tikzpicture}
                                    ...
                                    \unopBunopRpdos{1.125cm}{90 + (360/5)*2}
                                    \unotGunotYt{2.25cm}{90}
                                    \unotBunopGdos{1.125cm}{90 + (360/5)*3}
                                    \unopY{2.25cm}{90 + (360/5)*4}
                                    \unotRdos{2.25cm}{90 + (360/5)*3}
                ...
                \end{tcbitemize}
                \captionsetup{font=footnotesize}
                \caption{En tanto, $c_{1,2}$ se posiciona en $z$ y $c_{3,2}$ en
                $x$.}
            \end{figure}

            Si $R$ pasa, la posici\'on en (c) de \cref{fig:guarding3} es una
            an\'aloga a la mostrada en (a) de \cref{fig:guarding2} (uno en la
            vecindad de $w_2$ y el otro en la vecindad de $y$), por lo que
            eventualmente $R$ pone las fichas $r_1$ y $r_2$ en v\'ertices
            adyacentes. De lo contrario, si $R$ mueve $r_2$ a $b$, $c_{2,2}$ y
            $c_{4,2}$ le recapturan, mientras que $c_{1,2}$ se mueve a $w_2$
            (ver \cref{fig:intermedio}). En esta posici\'on $R$ est\'a obligado
            a mover $r_2$ de regreso a $w_1$. As\'i $C$ est\'a en una posici\'on
            an\'aloga a la mostrada en (a) de \cref{fig:guarding1} (una ficha en
            la vecindad de $b$), por lo que $R$ eventualmente posiciona $r_1$ y
            $r_2$ en v\'ertices adyacentes.
            ...
            \begin{figure}[ht!]
                ...
                \end{tcbitemize}
                \captionsetup{font=footnotesize}
                \caption{Posterior al movimiento de $R$, $C$ mueve sus
                polic\'ias como en (b) para obligar el regreso de $r_2$ a
                $w_1$.}
                \label{fig:intermedio}
            \end{figure}
            
            Finalmente, si $R$ mueve $r_1$ a $v$, $C$ mueve como en (b) de
            \cref{fig:guarding4}, obligando a $R$ a que ponga $r_1$ y $r_2$ en
            ...
            \begin{figure}[ht!]
                ...
                \end{tcbitemize}
                \captionsetup{font=footnotesize}
                \caption{En (a), $R$ acaba de mover $r_1$, de manera que $C$
                mueve como en (b) para posicionarse $c_{2,1}$ en $x$ y $c_{4,1}$
                en $u_2$, a la vez que $c_{1,1}$ y $c_{3,1}$ recapturan.}
                \label{fig:guarding4}
            \end{figure}
    ...
    posiciones adyacentes. M\'as a\'un, antes de que $r_1$ y $r_2$ est\'en en
    v\'ertices adyacentes, $c_{1,1}$ y $c_{3,1}$ capturaban a $r_1$, mientras
    que $c_{2,2}$ y $c_{4,2}$ capturaban a $r_2$. As\'i, sup\'ongase sin
    p\'erdida de generalidad que $r_1$ fue la \'ultima ficha movida, de modo que
    la situaci\'on es como se muestra en \cref{fig:guarding7}. Los polic\'ias
    proceden a posicionarse sobre las vecindades de los v\'ertices a los que
    puede mover $R$, dejando a $r_1$ sin movimientos. 
    
    Se generan tres casos dependiendo de la posici\'on de $c_{1,2}$ y $c_{3,2}$:

    \begin{enumerate}
        \item Si ninguno entre $c_{1,2}$ y $c_{3,2}$ est\'a en $b$ y no sucede
        que ambos esten $u_1$ o en $y$, entonces de (b) de \cref{fig:guarding7}
        es claro que $c_{1,2}$ y $c_{3,2}$ pueden ponerse, como en (c), en
        v\'ertices adyacentes a $y$ y $u_1$ respectivamente.
                    ...
                    \tcblower
                        \scalebox{0.7}{
                            \begin{tikzpicture}
                                ...
                                \unopBunopRdos{2.25cm}{90 + (360/5)*2}
                                \unotGunotYt{2.25cm}{90}
                                \unopGdos{1.125cm}{90 + (360/5)*2}
                                \unopY{1.125cm}{90 + (360/5)*3}
                            \end{tikzpicture}
                        }
            \end{tcbitemize}
            \captionsetup{font=footnotesize}
            \caption{En (a), $C$ busca poner a $c_{2,1}$ y $c_{4,1}$ en un
            v\'ertice azul sombreado y en un v\'ertice verde sombreado. Si
            alguno estuviera en los v\'ertices negros sombreados, en $v$, o en
            $w_2$, se sigue que $C$ captura a $R$ en a lo m\'as un turno, o
            est\'a en una configuraci\'on ilegal. El resto de v\'ertices tienen
            al menos un v\'ertice verde sombreado y uno azul sombreado en su
            vecindad cerrada. Por tanto, se pueden colocar $c_{2,1}$ y $c_{4,1}$
            de manera que estos impiden el movimeinto de $r_1$. An\'alogamente,
            $c_{1,2}$ y $c_{3,2}$ se mueven a un v\'ertice azul y uno verde (de
            los mostrados en (b)) respectivamente.}
            \label{fig:guarding7}
        \end{figure}
                    ...
                    \tcblower
                        \scalebox{0.7}{
                            \begin{tikzpicture}
                                ...
                                \unotBdos{1.125cm}{90 + (360/5)*4}
                                \unopGdos{1.125cm}{90 + (360/5)*2}
                                \unotRunopY{1.125cm}{90 + (360/5)*3}
                            \end{tikzpicture}
                        }
            \end{tcbitemize}
            \captionsetup{font=footnotesize}
            \caption{As\'i, $C$ termina su turno como se muestra en (c).}
        \end{figure}
    
        Si $R$ pasa como en (a) de \cref{fig:captura1}, $C$ mueve como en (b) para
        capturar a $R$ en su siguiente turno. De lo contrario, $R$ mueve $r_2$ a
        $u_2$ o a $y$. Sup\'ongase sin p\'erdida de generalidad que se mueve a
        $r_2$ como en (c), el otro caso es an\'alogo. En ese caso, $C$ mueve como en
        (d), capturando a $R$ en su siguiente turno.
        ...
        \begin{figure}[ht!]
                ...
                \tcbitem
                    \tcblower
                        \scalebox{0.70}{
                            \begin{tikzpicture}
                                \petersen
                                \unopBpdos{2.25cm}{90 + (360/5)}
                                \unopRdos{2.25cm}{90 + (360/5)*2}
                                \unotGunotY{2.25cm}{90}
                                \unopGtdos{1.125cm}{90}
                                \unotBdos{1.125cm}{90 + (360/5)*4}
                                \unotRdos{1.125cm}{90 + (360/5)*3}
                                \unopY{1.125cm}{90 + (360/5)*1}
                            \end{tikzpicture}
            ...
            \end{tcbitemize}
        \captionsetup{font=footnotesize}
        \caption{Posterior a que $R$ pase como en (a), $C$ mueve como en (b) para
        capturarle en su siguiente turno. En cambio, si $R$ mueve $r_2$ como en (c),
        $C$ mueve sus fichas como en (d), obligando a $R$ a pasar y captur\'andolo
        en su siguiente turno al reetiquetar las fichas de $c_2$.}
        \label{fig:captura1}
        \end{figure}

        \item Si alguno entre $c_{1,2}$ y $c_{3,2}$ est\'a en $b$, n\'otese que
        dicho polic\'ia (o ambos) puede reetiquetar sus fichas, de manera que la
        segunda ficha se encuentra en $v$ y es adyacente a ambos un v\'ertice
        azul sombreado y un v\'ertice verde sombreado, movi\'endose en ese mismo
        turno para obligar a $R$ a pasar y capturarle en a lo m\'as dos turnos
        (v\'ease (b) en \cref{fig:guarding8}).
        ...
        \begin{figure}[ht!]
                    ...
                    \tcblower
                        \scalebox{0.70}{
                            \begin{tikzpicture}
                                \petersen
                                \unopBpdos{2.25cm}{90 + (360/5)}
                                \unotBunopRdos{2.25cm}{90 + (360/5)*2}
                                \unotGunotYt{2.25cm}{90}
                                \unopGdos{1.125cm}{90 + (360/5)*2}
                                \unopY{1.125cm}{90 + (360/5)*3}
                                \unotRdos{2.25cm}{90 + (360/5)*4}
                    ...
                    \tcblower
                        \scalebox{0.7}{
                            \begin{tikzpicture}
                                ...
                                \unopRdos{2.25cm}{90 + (360/5)*2}
                                \unotGunotYt{2.25cm}{90}
                                \unotBunopGdos{1.125cm}{90 + (360/5)*2}
                                \unopY{1.125cm}{90 + (360/5)*3}
                                \unotRdos{2.25cm}{90 + (360/5)*4}
                            \end{tikzpicture}
                        }
            \end{tcbitemize}
            \captionsetup{font=footnotesize}
            \caption{En (a), $c_1$ se encuentra obstru\'ido, por lo que
            reetiqueta sus fichas como en (b). Luego, $C$ mueve como en (c), mientras que $c_{3,2}$ se
            asegura de estar en un v\'ertice adyacente a $y$ (reetiquetando en
            caso de que $c_2$ tambi\'en estuviera obstru\'ida).}
            \label{fig:guarding8}
        \end{figure}

        \item Si ambos $c_{1,2}$ y $c_{3,2}$ est\'an en $u_1$ o $y$, sup\'ongase
        sin p\'erdida de generalidad que est\'an en $u_1$, el otro caso es
        an\'alogo. En este caso, $C$ mueve $c_{3,2}$ a $z$ como en (b) de
        \cref{fig:guarding9}. Si $R$ pasa en este momento, se tiene una
        situaci\'on an\'aloga a la del caso $1$, por lo que $R$ debe mover $r_2$
        a $y$. Luego, $C$ mueve como en (d) de \cref{fig:guarding9} para obligar
        a $R$ a pasar y capturar en a lo m\'as dos turnos.
        ...
        \begin{figure}[ht!]
                    ...
                    \tcblower
                        \scalebox{0.7}{
                            \begin{tikzpicture}
                                ...
                                \puntodos{2.25cm}{90 + (360/5)}
                                \unopBunopRdos{2.25cm}{90 + (360/5)*2}
                                \unotBunotGdos{2.25cm}{90}
                                \unotYt{2.25cm}{90 + (360/5)*4}
                                \unopGdos{1.125cm}{90 + (360/5)*4}
                                \unopY{1.125cm}{90 + (360/5)*3}
                                \unotRdos{2.25cm}{90 + (360/5)*3}
            ...
            \end{tcbitemize}
            \captionsetup{font=footnotesize}
            \caption{En (a), $c_{1,2}$ y $c_{3,2}$ est\'an ambos en $u_1$, por
            lo que uno de ellos se mueve a $z$ como en (b). En (c), $R$ mueve
            $r_2$ a $y$, por lo que $C$ mueve como en (d) para obligar a $R$ a
            pasar y capturar en a lo m\'as dos turnos.}
            \label{fig:guarding9}
        \end{figure}
