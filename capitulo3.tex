...
\begin{proof}
    ...
    generalidad que su nueva posici\'on es $w_1$. Sea $N(w_1)=\l{u_1,
    r_2(t),y}$. Luego, $c_{2,2}$ y $c_{4,2}$ recapturan $r_2$ y se generan dos
    casos dependiendo de si se tiene una obstrucci\'on:
    ...
    \begin{enumerate}
        ...
        \begin{figure}[H]
            ...
            adyacente a $y$ y un v\'ertice adyacente a $r_2(t)$ respectivamente.
            El reetiquetado causa que $c_{2,1}$ sea adyacente al v\'ertice azul
            sin sombreado en (c), de modo que este a\'un cumple su funci\'on del
            paso anterior. Luego, $R$ solo puede pasar si es que quiere evitar
            que $r_1$ y $r_2$ est\'en en v\'ertices adyacentes. No obstante, $C$
            mueve sus polic\'ias como en (d).}
            \label{fig:guarding}
        \end{figure}
        ...
        \begin{enumerate}
            ...
            \item Si alguno est\'a en la vecindad cerrada de $w_2$ y el otro
            est\'a en la vecindad cerrada de $y$, sup\'ongase sin p\'erdida de
            generalidad que $c_{1,2}$ est\'a en la vecindad de $w_2$. As\'i,
            $c_{1,2}$ se mueve a $w_2$ y $c_{3,2}$ se mueve a $y$, obligando
            nuevamente a que $R$ mueva $r_1$ a $v$ (v\'ease
            \cref{fig:guarding2}).
        ...
        en $x$ y $u_2$ respectivamente. M\'as a\'un, $R$ viene de una posici\'on
        an\'aloga a alguna de las mostradas en (c) para
        ...
        %TODO: Agregar el caso donde se regresa a la obstrucción.
