...
decir, $c_{1,i}, \dots, c_{i-1,i}, c_{i+1,i}, \dots, c_{k,i}$ capturan a $r_i$
al turno $t$. De forma similar, decimos que $R$ est\'a \textbf{bajo asedio} en
el turno $t$ si cada una de sus fichas lo est\'a (en el mismo turno $t$).
...
%Definir centro de la estrella, notar que el obstructor da una nueva instancia
%I(t+1) para cada c_i, llamarla c_i(t+1) (es el conjunto de parejas ordenadas
%(c_{i,j},c_{i,j}(t))).
...
$S_n$. Adem\'as, estas inician con un etiquetado ya establecido, de manera que
