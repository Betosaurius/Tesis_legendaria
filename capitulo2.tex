...
que no se le asoci\'o ninguna ficha de $R$. As\'i, $c_{i,i}$ es la \textbf{ficha
...
cuando sea necesario resolver obstrucciones. En las siguientes demostraciones
utilizaremos este etiquetado y asignaciones de objetivos.
...
\begin{proof}
    ...
    i$, mientras que su ficha libre no se mover\'a. Se ver\'a que en cada turno
