...
\begin{proof}
    ...
    distancias de sus fichas a sus objetivos en al menos $1$. Luego, si $R$
...
\begin{algorithm}[htb!]
    \SetAlgorithmName{Algoritmo}{}
      ...
      \While{$C$ no est\'e capturando a $R$ en $I(t)$}{
            ...
            \If{existe $j\ne i$ tal que $c_{i,j}$ no est\'a capturando a $r_j$}{
                ...
                \If{existe $s$ tal que $c_{i,s}(t) = v_{i,j}$}{
                    \If{$s=i$ y $v_{i,j}=r_j(t)$}{
                        $c_{i}(t+1) \gets$ la configuraci\'on $c_i(t)$
                        intercambiando las etiquetas de $c_{i,s}$ y $c_{i,j}$\;
                    }\Else{
        ...
        \If{$C$ est\'a capturando a $R$ en $I(t)$}{
            \Continue\;
        }\Else{
